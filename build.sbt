...
libraryDependencies ++= Seq( jdbc , anorm , cache , ws ,
  ...
  "org.apache.curator" % "curator-recipes" % "2.7.0" withSources() withJavadoc(),
  "org.apache.solr" % "solr-core" % "5.1.0" withSources() withJavadoc() excludeAll(ExclusionRule(organization = "org.slf4j"), ExclusionRule(organization = "com.google.protobuf")),
  "org.apache.solr" % "solr-solrj" % "5.1.0" withSources() withJavadoc(),
  ...
  "com.hierynomus" % "sshj" % "0.11.0" withSources()
)
